...
cap = cv2.VideoCapture('/home/pi/Desktop/python/testvideo2.mp4')
...
while(True):
    ...
    pts = np.array([[60, 190], [275, 60], [380, 60], [575, 190]], dtype=np.int32)
    cv2.fillConvexPoly(mask, pts, 180)
